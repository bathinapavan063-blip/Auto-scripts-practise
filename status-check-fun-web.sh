...
static_web_page () {
  ...
  then
     echo "Index.html is avaiable for launching the static website page"
  else 
    echo "Index.html is not available for launching the website page"
    echo "Adding Index.html page in /var/www/html location"
    cp -r /temp/index.html /var/www/html/index.html
